    ...
    methods:{
        ...
        fetchOriginSupervision:function(iid){
            ...
            success: function (result) {
                ...
                let orgtree=_this.userLogin.orgtree;
                if(orgtree[2]){
                    for(let key in orgtree[2]){
                        _this.isResponseble=(key==_this.responsibledeptcode);
                    }
                }
                _this.isResponseble=_this.isResponseble||(_this.responsiblesn==_this.userLogin.userid);
        ...
        updateProgress:function(){
          if(this.userLogin.updateuserid!=this.accountablesn&&!this.isResponseble){
