<template>
	 ...
	 <!-- start -->
			...
			<!-- </div> -->
           <!-- end -->
           <a class="btn btn-sm find-more" v-if="dataSource.subcard_ISMORE" style="position: absolute;top: -5px;right: -1rem;" :href="dataSource.subcard_MORE_URL+'&column='+dataSource.subcard_ZH" target="_blank">>>
                </a>
	</div>
</template>
<script>
