...
let filterVm = new Vue({
    ...
    data: {
        ...
        depts: {show: [], more: []},
        stateList: [
            {label: "编制中", value: true, feature: "label-success", margin: '50%'},
            {label: "执行中", value: true, feature: "label-warning", margin: ''},
...
var resultVm = new Vue({
    ...
    data: {
        ...
        // {key: "code", val: '督办编号'},
            ...
            {key: "starttime", val: '开始时间'},
            {key: "finishtime", val: '完成时间'},
            {key: "lastupdatetime", val: '最后更新时间'}
            // {key: "rate", val: '最新进展'}
        ],
        keyItems: {
            sorting: sortings,
