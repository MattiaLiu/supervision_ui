                ...
                <ul class="nav-list">
                    <li class="nav-list-item" id="comPortalNav">
                        ...
                        <div class="nav-panel company">
                            ...
                            <ul>
                                <!-- /.list-item -->
                                <li class="list-item"><a class="btn" href="http://fqnpc.cnnp.com.cn/"
                                                         target="_blank">福清核电</a></li>
                                <li class="list-item"><a class="btn" href="http://fqportal.cnnp.com.cn/wps/portal"
                                                         target="_blank">福清核电(原)</a></li>
                    ...
                    <li class="nav-list-item"><a @click="gotoWorkbench" class="navbar-link workbench" >个人工作台<span v-if="taskAlert" class="glyphicon glyphicon-flag"></span></a></li>
    ...
    module.exports={
        ...
        methods:{
            gotoWorkbench:function(){
                ...
                window.open("http://bjecm.cnnp.com.cn/pt/LoginServlet?url="+url);
            },
            ...
            loginIn:function(){
             ...
             window.open("http://bjecm.cnnp.com.cn/pt/LoginServlet?url="+Base64.encode(t));
            },
             loginOut:function(){                 
                ...
                $.ajax({
                    ...
                    success:function(result){
                        if(result.length==0){  
                            ...
                            if(typeof orgtree =="object")orgtree=JSON.stringify(orgtree);
            ...
            fetchTaskCount(uid){
                let that=this;
                $.ajax({
                    url:window.interfaceSettings.personalpage_isolateRequest.api.taskCountWithoutKey,
                    type:"post",
                    ...
                    success:function(result){
                        ...
                        if(count>0)that.taskAlert=true;
                        else that.taskAlert=false;
                    },
